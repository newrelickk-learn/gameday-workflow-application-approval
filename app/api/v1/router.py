...
from app.api.v1.endpoints import applications, approvals, game_progress, chapter2_diagnosis
...
api_router.include_router(chapter2_diagnosis.router, tags=["Chapters"])
